...
También se puede lanzar AMCL mediante ros2 launch nav2_bringup localization_launch.py map:=./mapa_amcl.yaml use_sim_time:=false fijándonos en el mapa que hayamos creado y en la ruta correcta. Antes deberemos guardar el mapa que estemos creando con slam-toolbox usando el paquete de Nav2 ros2 run nav2_map_server map_saver_cli -f my_map
